...
#include "programl/ir/llvm/internal/klee_llvm_lib/basic.h"
...
static std::string MERGE_POINT_FILENAME_KEYWORD_ALLOWLIST[] = {};
static std::string MERGE_POINT_DIRNAME_KEYWORD_ALLOWLIST[] = {"obj-llvm"};
